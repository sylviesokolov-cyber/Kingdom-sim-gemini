...
| 2026-09-13 | `c84a0e9` | pass | 145 pass | pass | **green** | Narrative event engine — 24 events, delayed consequences, event modal. Browser-verified at 740×360/900×420/1280×600. Merged into the default branch `claude/kingdom-simulator-bonding-0288cn` as a clean fast-forward (1 commit ahead, 0 behind, no conflict). CI run 34729928033 and Pages deploy run 34729927998 both green on the merged commit. |
